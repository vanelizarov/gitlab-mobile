...
class BidirectionalScrollView extends StatefulWidget {
  BidirectionalScrollView({@required this.child, this.velocityFactor, this.scrollListener});
  ...
  State<StatefulWidget> createState() {
    _state = _BidirectionalScrollViewState(child, velocityFactor, scrollListener);
    return _state;
  }
...
class _BidirectionalScrollViewState extends State<BidirectionalScrollView>
  ...
  _BidirectionalScrollViewState(
      Widget child, double velocityFactor, ValueChanged<Offset> scrollListener) {
    _child = child;
  ...
  void _handlePanEnd(DragEndDetails details) {
    ...
    _enableFling = true;
    _flingAnimation =
        Tween<Offset>(begin: Offset(0.0, 0.0), end: direction * distance * _velocityFactor)
            .animate(_controller);
    _controller
      ..value = 0.0
